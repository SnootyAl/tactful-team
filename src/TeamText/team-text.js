module.exports = {
	C: {
		low: ` – they may be more likely to be impulsive, 
...
It might be worth checking in on them periodically to keep them on track.`,
		high: ` – they may be best suited to planning 
...
person to ask for help.`,
	...
	N: {
		low: ` – this means they may be more optimistic, worry 
...
you moving in the right direction.`,
		high: ` – this means they might get stressed easily 
...
all you have to do is listen.`,
	...
	E: {
		low: ` - they may be more reserved, and have 
...
include them in team conversations will reveal that they are an important part of the team.`,
		high: ` - they may seek excitement or adventure 
